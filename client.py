...
iterationsServ1_step1 = raw_input('Iter serv1 step 1 ? ') #1000
iterationsServ2_step1 = raw_input('Iter serv2 step 1 ? ') #10
iterationsServ1_step2 = raw_input('Iter serv1 step 2 ? ') #50
iterationsServ2_step2 = raw_input('Iter serv2 step 2 ? ') #50000
iterationsServ1_step3 = raw_input('Iter serv1 step 3 ? ') #1000
iterationsServ2_step3 = raw_input('Iter serv2 step 3 ? ') #150
...
b_max = 100
b_pas = 1
iterationsServ1_step1 = 1000
iterationsServ2_step1 = 10
iterationsServ1_step2 = 50
iterationsServ2_step2 = 50000
iterationsServ1_step3 = 1000
iterationsServ2_step3 = 150
nombreServeurs = 2
...
#///// Send des parametres au gestionnaire /////
